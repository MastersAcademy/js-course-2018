...
console.log(`Square root of 5 is: ${squareNum(5)}`);
console.log(`Square root of 5 is: ${squareNum(15)}`);
console.log(`Square root of 5 is: ${squareNum(53)}`);
...
console.log(`Square root of all of the nums between 0 adn 32 with step 4 are: \n${arrSquareNum}`);
